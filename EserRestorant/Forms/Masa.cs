...
namespace EserRestorant
{
    public partial class Masa : Form
    {
        ...
        {
            frmPaketSiparis siparis = new frmPaketSiparis();
            int uzunluk = btnMasa1.Text.Length;

            clsGenel._ButtonValue = btnMasa1.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa1.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa2_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa2.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa2.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa3_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa3.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa3.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa4_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa4.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa4.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa5_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa5.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa5.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa6_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa6.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa6.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa7_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa7.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa7.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa8_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa8.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa8.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa9_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa9.Text.Substring(uzunluk - 6, 6);
            clsGenel._ButtonName = btnMasa9.Name;
            this.Close();
            siparis.Show();
        }
        ...
        private void btnMasa10_Click(object sender, EventArgs e)
        {
            ...
            clsGenel._ButtonValue = btnMasa10.Text.Substring(uzunluk - 6, 6);
